...
NODE_ENV=development NODE_OPTIONS=--no-deprecation node_modules/.bin/payload migrate:create --name initial 2>&1 || true
NODE_ENV=development NODE_OPTIONS=--no-deprecation node_modules/.bin/payload migrate 2>&1 || true
echo "✅ Schema listo"
